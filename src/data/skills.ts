...
export const skills: Skill[] = [
  ...
  { name: 'TensorFlow', icon: 'Activity', category: 'AI/ML', proficiency: 85 },
  { name: 'PyTorch', icon: 'Flame', category: 'AI/ML', proficiency: 80 },
  { name: 'OpenAI', icon: 'Sparkles', category: 'AI/ML', proficiency: 85 },
  { name: 'Generative AI', icon: 'Sparkles', category: 'AI/ML', proficiency: 80 },
  { name: 'Agentic AI', icon: 'Bot', category: 'AI/ML', proficiency: 75 },
